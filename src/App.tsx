...
const LOCATIONS = [
  ...
  { id: 'herefordshire',        label: 'Herefordshire',        group: 'West Mercia' },
  { id: 'shropshire',           label: 'Shropshire',           group: 'West Mercia' },
  { id: 'telford',              label: 'Telford & Wrekin',     group: 'West Mercia' },
  ...
  { id: 'stoke',                label: 'Stoke-on-Trent',       group: 'Staffordshire' },
